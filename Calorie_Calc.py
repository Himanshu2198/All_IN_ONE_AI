...
# import os
# os.environ['GOOGLE_API_KEY'] = "AIzaSyCQPEW8X-Nifr5M2lGQrrq1dICU2LNydyg"
...
def input_image_setup(uploaded_file):
    ...
    if uploaded_file is not None:
        ...
        image_parts = [
            {
                "mime_type": uploaded_file.type,# Get the mime type of the uploaded_file
                "data": bytes_data
            }
        ]
        return image_parts
...
#Initialize the streamlit app ....front end
...
You are an expert in nutritionist where you need to see the food items from the image 
                ...
                ----
                ----
        Finally you can also mention whether the food is healthy or not and also metion
